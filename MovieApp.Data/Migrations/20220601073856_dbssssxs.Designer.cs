...
namespace MovieApp.Data.Migrations
{
    ...
    [Migration("20220601073856_dbssssxs")]
    partial class dbssssxs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieApp.Entity.BookingModel", b =>
                {
                    ...
                    b.Property<int>("showTimeModelId")
                        .HasColumnType("int");

                    b.HasKey("bookingid");

                    b.HasIndex("showTimeModelId");
            ...
            modelBuilder.Entity("MovieApp.Entity.BookingModel", b =>
                {
                    b.HasOne("MovieApp.Entity.MovieShowTimeModel", "movieShowTimeModel")
                        .WithMany()
                        .HasForeignKey("showTimeModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("movieShowTimeModel");
                });
